...
/**
 * Adapter for the GridView layout.
 *
 * @author Saravan Pantham
 */
public class GridLayoutAdapter extends AbstractFileBrowserAdapter {

    public GridLayoutAdapter(Context context, FileBrowserView fileBrowserView,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.fileFolderIcon = (ImageView) convertView.findViewById(R.id.gridViewImage);
            holder.fileFolderSizeText = (TextView) convertView.findViewById(R.id.gridViewSubText);
            holder.fileFolderNameText = (TextView) convertView.findViewById(R.id.gridViewTitleText);
